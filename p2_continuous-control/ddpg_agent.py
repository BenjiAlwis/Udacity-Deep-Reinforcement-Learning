...
class Agent():
    def __init__(self, state_size, action_size, n_agents=1, seed=0):
        ...
        self.actor_local = Actor(state_size, action_size, leak=LEAKINESS, seed=seed,bn_mode=BATCH_NORM_MODE).to(device)
        self.actor_target = Actor(state_size, action_size, leak=LEAKINESS, seed=seed,bn_mode=BATCH_NORM_MODE).to(device)
