...
class Maddpg():
    ...
    def checkpoints(self):
        ...
        for idx, agent in enumerate(self.agents):
            actor_local_filename = 'results/checkpoint_actor_local_' + str(idx) + '.pth'
            critic_local_filename = 'results/checkpoint_critic_local_' + str(idx) + '.pth'           
            actor_target_filename = 'results/checkpoint_actor_target_' + str(idx) + '.pth'
            critic_target_filename = 'results/checkpoint_critic_target_' + str(idx) + '.pth'            
